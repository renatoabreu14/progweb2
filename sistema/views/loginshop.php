...
session_start();
echo var_dump(md5($_POST['senha']));
if (isset($_POST['login'])){
    $email = $_POST['email'];
    $senha = md5($_POST['senha']);
    if (ClienteController::loginshop($email, $senha)){
           ...
           <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <form action="loginshop.php" class="create-account-form" method="post">
                    ...
                    <div class="col-md-6 col-sm-6">
                       <form action="loginshop.php" class="create-account-form" method="post">
                            ...
                            <div class="submit">					
                                <button name="login" id="submitcreate" type="submit" class="btn-default">
                                    <span>
                                        <i class="fa fa-user left"></i>
                                        SING IN
                                    </span>
